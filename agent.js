...
const INTENT_TOOLS = {
  ...
  paper:       new Set(["open_paper_position", "get_paper_position", "close_paper_position", "list_paper_positions"]),
};
...
const INTENT_PATTERNS = [
  ...
  { intent: "paper",       re: /\b(paper|sim(?:ulate)?|virtual position|dry.?run)\b/i },
];
